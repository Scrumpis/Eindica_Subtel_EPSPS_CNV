...
DOI: [10.1038/s41467-023-40407-6](https://www.nature.com/articles/s41467-023-40407-6)  
...
#### Tree generation:
[Eindica_Subtel_Tree](https://github.com/Scrumpis/Eindica_Subtel_EPSPS_CNV/tree/main/Eindica_Subtel_Tree) contains `Eindica_Subtel_Tree_V5.R` to create the below tree as well as the only needed source file, `Eindica_R_S_EPSPS_SubTels.afa.raxml.bestTree.clean_labels`. Make sure to change the working directory in the Rscript. The included `Eindica_Subtel_Tree.svg` was exported as a 600x600 SVG file using [RStudio](https://posit.co/download/rstudio-desktop/) (version 2023.06.0+421).  
